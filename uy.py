...
xi = {
    ...
    "x5" : int(input("Masukkan nilai x5: ")),
    "x6" : int(input("Masukkan nilai x6: ")),
    "x7" : int(input("Masukkan nilai x7: ")),
    "x8" : int(input("Masukkan nilai x8: ")),
    "x9" : int(input("Masukkan nilai x9: ")),
    "x10": int(input("Masukkan nilai x10: "))
}
...
#inisialisasi variabel-variabel yang tergabung dalam Soal
c1 = 1/2
c2 = 1
...
#fungsi untuk yang akan mengambil langsung nilai xi dan menyimpannya kedalam array Pbesti jika sedang dalam iterasi pertama
...
for index in range(n):
    ...
    x_minimum(xi["x1"],xi["x2"],xi["x3"],xi["x4"],xi["x5"],xi["x6"],xi["x7"],xi["x8"],xi["x9"],xi["x10"])
